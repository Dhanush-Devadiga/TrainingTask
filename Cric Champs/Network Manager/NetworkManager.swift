...
class NetworkManager {
    ...
    func putData(url: String, parameters: [String: Any], headers: [String: String]?, image: UIImage?, imageFieldName: String?, completion: @escaping(HTTPURLResponse, Any? , Error?) -> Void) {
        let imageData = image?.jpegData(compressionQuality: 0.9)
