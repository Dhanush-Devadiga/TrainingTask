...
class LoginViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        loginButton.setUpButtonBackGround( colours: [ #colorLiteral(red: 1, green: 0.7294117647, blue: 0.5490196078, alpha: 1), #colorLiteral(red: 0.9960784314, green: 0.3607843137, blue: 0.4156862745, alpha: 1)], cornerRadius: 0)
    }
    ...
    @IBAction func onLogInTapped(_ sender: UIButton) {
        ...
        loginVM.user = User(id: nil, email: email, password: password, name: nil, photo: nil)
